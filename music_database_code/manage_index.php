...
<center>
<input type="button" value="新增歌曲" onclick="location.href='manage_add.php'" style="width:200px;height:40px;font-size:20px">
<input type="button" value="刪除歌曲" onclick="location.href='manage_del.php'" style="width:200px;height:40px;font-size:20px">
<!-- <input type="button" value="修改歌曲" onclick="location.href='manage_modify.php' "style="width:200px;height:40px;font-size:20px"> -->
</center>    
